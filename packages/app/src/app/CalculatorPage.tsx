...
// Tree-shaken date-fns imports (ESM) - reduces bundle by ~150KB
...
// Framer Motion - keep for now, will optimize in next phase
...
// HeroSection removed - now rendered by parent Server Component for instant HTML load
  ...
  return (
    <div className="min-h-screen font-dm-sans bg-gray-50">
      ...
      */}
      ...
      {/* Calculator Section */}
      <section id="calculator" ref={calculatorRef} className="pb-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
